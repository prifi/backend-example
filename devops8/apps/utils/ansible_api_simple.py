...
class ANSRunner(object):
    ...
    def __initializeData(self):
        ...
        self.options = Options(connection='smart', module_path=None, forks=5, timeout=10,
                               remote_user='liuziping', ask_pass=False, private_key_file=None, ssh_common_args=None,
                               ssh_extra_args=None,
...
if __name__ == '__main__':
    rbt = ANSRunner()
    rbt.run_playbook(playbook_path='/home/liuziping/restfuldemo/playbook/2019/02/play.yaml')
